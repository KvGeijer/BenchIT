...
#define KERNEL_DESCRIPTION  "multi threaded memory bandwidth (load-store 1:1)"
...
typedef struct threaddata
{
   ...
   #endif
   #ifdef USE_PAPI
   unsigned char padding1[55];                          //113+24+55 = 192
   #else
   unsigned char padding1[15];                          //113+15 = 128
   #endif
